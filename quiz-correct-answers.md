...
Compiled from quiz screenshots. Each entry lists the question, the correct answer, and the explanation given.

## Question 1

**Question:** You are the Digestive Care SAE and have come across an industry association that appears to offer useful information and shares relevant topics in the Digestive Care space. You talked to your manager, and she agrees that it would be a good use of your time. What can you do?

**Options:**

- A. Sign up to participate given that your manager agrees.
- B. Reach out to Antitrust Legal to seek approval to participate.
- C. Decline participation in the association as you remember in policy training that trade associations are not allowed.
- D. Sign up to participate but only if you have confirmed that there are no competitors in the trade association.
...
- A. If the customer reduced its resale price to only $8.99, P&G can choose not to pay any funding.
- B. If the customer reduced its resale price to $6.99, P&G must pay $4.
- C. If the customer reduced their resale price to $6.99, P&G must pay $3 per unit sold.
- D. Both A & C
...
**Question:** What CAN you do when we discuss with our retailers the shelf price of P&G products?

**Options:**

- A. Make recommendations/proposals regarding the suggested retail price (SRP).
- B. Disclose other retailers' future pricing plan for their reference.
- C. Calculate the estimated customer's margin at assumed suggested retail price, but making clear that pricing and margin are at the sole discretion of the retailer and that we are not entering into an agreement on their pricing decisions.
- D. Both A & C
